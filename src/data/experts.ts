...
const baseExperts: Expert[] = [
  {
    ...
    description: "안녕하세요! 여러분의 작은 건강 습관을 함께 만들어갈 영양사 정인수입니다. 대학병원 영양팀 인턴을 거쳐 현재는 지역 보건소와 건강센터에서 식습관 개선 프로그램을 운영하고 있어요. 누구보다 쉽게, 그러나 정확하게! 식단과 생활습관이 삶에 스며들 수 있도록 도와드리는 것이 저의 목표입니다. 특히 당뇨∙고지혈증∙비만 등 만성질환 예방을 위한 식단 설계와, 바쁜 일상 속에서도 실천 가능한 건강 습관 만들기를 중심으로 상담하고 있어요. 단기적인 식단 처방보다, 지속 가능한 건강 루틴을 함께 만들어가요. 작지만 꾸준한 변화가 여러분의 건강을 바꿉니다. 함께 시작해볼까요?",
    profile: "",
    careers: [
      "-웰니스 코치 자격증 보유",
      "-김신 근무 경력 2년",
