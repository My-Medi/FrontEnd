...
<div className={`flex items-center rounded-[14px] px-6 py-2 border-2 border-solid border-[#DBE6FF] ${value === '해당' ? 'bg-[#DBE6FF]' : 'bg-white'}`}>
        <label className="w-40  font-semibold text-[20px]">추가검사</label>
        <div className="flex gap-10 font-medium text-[20px] ml-10">
          {['해당', '미해당'].map((v) => (
      ...
      {value === '해당' && (
        <div className="mt-[24px] bg-white rounded-[14px] px-6">
          {/* 각 추가검사 항목 반복 */}
          {examList.map((exam, idx) => {
            ...
            <div
              key={exam.key}
              className={`flex items-start mb-6 ${idx !== examList.length - 1 ? 'border-b-3 border-[#eaf1ff] pb-[24px]' : ''}`}
            >
              {/* 해당 체크박스 */}
              <div className="flex items-center min-w-[60px] font-medium text-black text-[18px]">
              ...
              {/* 검사명 */}
              <div className="ml-40 min-w-[110px] font-medium text-black text-[18px]">{exam.label}</div>
              {/* 세부 옵션: B형간염 */}
              {exam.key === 'hepatitis' && (
                <div className={`ml-[218px] flex flex-wrap gap-4 text-[18px] font-medium ${!isEnabled ? 'opacity-50 pointer-events-none' : ''}`}>
                  <div className="flex flex-col gap-4">
                  <div className="flex items-center gap-4">
                    <span className="text-medium text-gray-700 w-15 text-[18px] whitespace-nowrap">포면항원</span>
                  ...
                  <div className="flex items-center gap-4">
                    <span className="text-medium text-gray-700 w-15 text-[18px] whitespace-nowrap">표면항체</span>
                    <svg xmlns="http://www.w3.org/2000/svg" width="4" height="40" viewBox="0 0 4 40" fill="none" className="mr-4">
                      <path d="M2 2V38" stroke="#DBE6FF" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" strokeDasharray="6 6"/>
                    </svg>
              ...
              {/* 세부 옵션: 우울증 */}
              {exam.key === 'depression' && (
                <div className={`flex flex-col gap-4 text-[18px] font-medium ${!isEnabled ? 'opacity-50 pointer-events-none' : ''}`}>
                  <div className="ml-[218px] flex flex-wrap gap-19 text-[18px]">
                  ...
                  <div className="ml-[218px] flex flex-wrap gap-10 text-[18px]">
              ...
              {/* 세부 옵션: 인지기능장애 */}
              {exam.key === 'cognitive' && (
                <div className={`ml-[218px] flex flex-wrap gap-10 text-[18px] font-medium ${!isEnabled ? 'opacity-50 pointer-events-none' : ''}`}>
              ...
              {exam.key === 'seniorPhysical' && (
                <div className={`ml-[205px] flex flex-wrap gap-10 text-[18px] font-medium ${!isEnabled ? 'opacity-50 pointer-events-none' : ''}`}>
              ...
              {exam.key === 'seniorFunction' && (
                <div className={`ml-[218px] flex flex-col gap-4 text-[18px] font-medium ${!isEnabled ? 'opacity-50 pointer-events-none' : ''}`}>
                  {/* 낙상 */}
                  <div className="flex items-center text-[18px]">
                    <span className="text-medium text-gray-700 w-20 whitespace-nowrap">낙상</span>
                    <svg xmlns="http://www.w3.org/2000/svg" width="4" height="40" viewBox="0 0 4 40" fill="none" className="mr-4">
                      <path d="M2 2V38" stroke="#DBE6FF" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" strokeDasharray="6 6"/>
                    </svg>
                  ...
                  {/* 일상생활 수행능력 */}
                  <div className="flex items-center text-[18px]">
                    <span className="text-medium text-gray-700 w-32 whitespace-nowrap mr-[15px]">일상생활 수행능력</span>
                    <svg xmlns="http://www.w3.org/2000/svg" width="4" height="40" viewBox="0 0 4 40" fill="none" className="mr-4">
                      <path d="M2 2V38" stroke="#DBE6FF" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" strokeDasharray="6 6"/>
                    </svg>
                    <div className="flex gap-10 text-[18px]">
                  ...
                  {/* 예방접종 */}
                  <div className="flex items-center text-[18px]">
                    <span className="text-medium text-gray-700 w-20 whitespace-nowrap">예방접종</span>
                    <svg xmlns="http://www.w3.org/2000/svg" width="4" height="40" viewBox="0 0 4 40" fill="none" className="mr-4">
                      <path d="M2 2V38" stroke="#DBE6FF" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" strokeDasharray="6 6"/>
                    </svg>
                    <div className="flex gap-10 text-[18px]">
                  ...
                  {/* 배뇨장애 */}
                  <div className="flex items-center text-[18px]">
                    <span className="text-medium text-gray-700 w-20 whitespace-nowrap">배뇨장애</span>
                    <svg xmlns="http://www.w3.org/2000/svg" width="4" height="40" viewBox="0 0 4 40" fill="none" className="mr-4">
                      <path d="M2 2V38" stroke="#DBE6FF" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" strokeDasharray="6 6"/>
                    </svg>
                    <div className="flex gap-10 text-[18px]">
