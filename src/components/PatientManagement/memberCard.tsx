...
//   // AdviceRegisterModal을 여는 함수
//   const openAdviceRegisterModal = () => {
//     setShowMemberCardModal(false); // MemberCardModal 닫기
//     setShowAdviceRegisterModal(true); // AdviceRegisterModal 열기
//   };

//   // AdviceRegisterModal을 닫는 함수
//   const closeAdviceRegisterModal = () => setShowAdviceRegisterModal(false);

//   //ConsultReservationModal을 여는 함수
//   const openConsultReservationModal = () => {
//     setShowMemberCardModal(false); // MemberCardModal 닫기
//     setShowConsultReservationModal(true); // ConsultReservationModal 열기
//   };

//   //ConsultReservationModal을 닫는 함수
...
//       </div>
//       {/* 모달 */}
//       {/* {isModalOpen && <MemberCardModal member={member} onClose={closeModal} />} */}
//       {/* MemberCardModal 열기 */}
//       {/* MemberCardModal을 여는 버튼 */}
//       {showMemberCardModal && (
//         <MemberCardModal
//           member={member}
//           onClose={() => setShowMemberCardModal(false)}
//           openAdviceRegister={openAdviceRegisterModal} // openAdviceRegister 전달
...
//       {/* ConsultReservationModal 열기 */}
//       {showConsultReservationModal && (
//         <ConsultReservationModal onClose={closeConsultReservationModal} />
//       )}
//       {showConsultDateModal && <ConsultDateModal onClose={closeConsultDateModal} />}
//     </div>
//   );
// };
