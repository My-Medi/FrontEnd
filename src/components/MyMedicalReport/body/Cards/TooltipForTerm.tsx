...
const TOOLTIP_TEXT_MAP: Record<string, string | undefined> = {
  ...
  '공복혈당(FBS)': '피 속에 설탕이 얼마나 있는 지 확인할 수 있어요!',
  총콜레스테롤: '피 속 기름이 얼마나 있는 지 알 수 있어요!',
  HDL콜레스테롤: '나쁜 기름을 치워주는 착한 기름이 얼마나 있는 지 알려줘요!',
  중성지방: '먹고 남은 에너지가 기름이 되어 쌓인거에요!',
  LDL콜레스테롤: '혈관을 막는 나쁜 기름이 얼마나 있는 지 알려줘요!',
  '혈청 크레아티닌': '콩팥이 찌꺼기를 잘 버리는 지 알 수 있어요!',
  '신사구체여과율(eGFR)': '콩팥 속 작은 필터가 잘 작동하는 지 알 수 있어요!',
  'AST(SGOT)': '아프면 올라가는 간 수치를 알 수 있어요!',
  'ALT(SGPT)': '아프면 올라가는 간 수치를 알 수 있어요!',
  '감마GTP(Y-GTP)': '간이 술이나 기름진 음식으로 힘들어하는 지를 확인해요!',
