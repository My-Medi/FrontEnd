      ...
      >
        ...
        <div className="w-full flex flex-row items-center pl-[46px] pr-6 pt-10 pb-6 flex-shrink-0">
          ...
          <div className="flex-1 flex flex-col items-center">
            ...
            <div className="text-[#121218] text-2xl font-semibold leading-[1.5]">{expert.name} / {expert.position}</div>
          </div>
        ...
        <div className="w-full flex flex-col items-center px-6 pb-0 flex-1 overflow-y-auto min-h-0">
          ...
          <div className="w-full flex flex-col px-6">
            ...
            <div className="w-full flex mb-6">
              <div className="text-center text-xl font-medium text-[#121218] leading-[1.19]">{expert.slogan}</div>
            </div>
            {/* 전문가 소개 */}
            <div className="w-full flex flex-col mb-6">
              ...
              <div className="text-base text-[#121218] whitespace-pre-line leading-[1.375] pl-11 font-normal">{expert.introduction}</div>
            </div>
            {/* 소속/전문분야 */}
            <div className="w-full flex flex-row gap-16 mb-6">
              <div className="flex-1 flex flex-col">
                ...
                <div className="text-base text-[#121218] whitespace-pre-line leading-[1.375] pl-11 font-normal">{expert.affiliation}</div>
              </div>
              <div className="flex-1">
                ...
                <div className="text-base text-[#121218] whitespace-pre-line leading-[1.375] pl-11 font-normal">{expert.specialty}</div>
              </div>
            </div>
            {/* 경력사항 */}
            <div className="w-full flex flex-col mb-6">
                ...
                <div className="text-base text-[#121218] whitespace-pre-line leading-[1.375] pl-11 font-normal">{expert.career}</div>
            </div>
          </div>
        </div>
        {/* 하단 버튼 */}
        <div className="w-full flex flex-row justify-center gap-12 px-6 pb-12 flex-shrink-0">
          ...
          <button className="w-[300px] h-14 rounded-full bg-[#1D68FF] text-white text-xl font-semibold transition cursor-pointer"
