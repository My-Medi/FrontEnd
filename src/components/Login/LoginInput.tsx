      ...
      <div className="flex flex-col gap-2 w-[385.2px]">
        ...
        <div className="relative">
          <input
            ...
            id={id}
            name={name}
            className="w-[385.2px] h-12 px-5 text-[14px] border border-[#9DA0A3] rounded-xl placeholder:text-[#9DA0A3] focus:outline-none focus:ring-2 focus:ring-gray-500 font-medium leading-[1.714] tracking-[-3%]"
