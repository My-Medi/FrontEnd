      ...
      <div className="flex flex-col gap-2 w-full max-w-[24rem] xl:w-[24rem] md:w-full sm:w-full">
        ...
        <div className="relative">
          <input
            ...
            id={id}
            name={name}
            className="w-full h-12 xl:h-12 md:h-11 sm:h-10 px-4 xl:px-5 md:px-4 sm:px-3 text-sm xl:text-sm md:text-sm sm:text-xs border border-[#9DA0A3] rounded-xl placeholder:text-[#9DA0A3] focus:outline-none focus:border-[#75787B] font-medium leading-[1.714] tracking-[-3%]"
